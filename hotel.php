...
$categoryLarge = $_GET['category_large'] ?? '호텔'; // 기본값을 '호텔'로 설정
...
<body>
    ...
    <section class="search-section">
        <div class="search-wrapper">
            <a href="#" class="logo">호텔</a>
            <form class="search-form" action="search.php" method="GET">
                <div class="input-group">
                    <input type="text" placeholder="호텔을 검색해보세요 !" class="wide-input">
                </div>
                <div class="input-group">
        ...
        <div class="carousel-container">
            <div class="carousel">
                <div class="carousel-item">
                    <img src="img/event/1.png" alt="이벤트 1">
                </div>
                <div class="carousel-item">
                    <img src="img/event/2.png" alt="이벤트 2">
                </div>
                <div class="carousel-item">
                    <img src="img/event/3.png" alt="이벤트 3">
                </div>
                <div class="carousel-item">
                    <img src="img/event/4.png" alt="이벤트 4">
                </div>
                <div class="carousel-item">
                    <img src="img/event/5.png" alt="이벤트 5">
                </div>
                <div class="carousel-item">
                    <img src="img/event/6.png" alt="이벤트 6">
                </div>
                <div class="carousel-item">
                    <img src="img/event/7.png" alt="이벤트 7">
                </div>
                <div class="carousel-item">
                    <img src="img/event/8.png" alt="이벤트 8">
                </div>
                <div class="carousel-item">
                    <img src="img/event/9.png" alt="이벤트 9">
                </div>
            </div>
            <!-- 네비게이션 -->
