...
$categoryLarge = $_GET['category_large'] ?? '글램핑'; // 숙소 유형 필터
...
<body>
    ...
    <section class="search-section">
        <div class="search-wrapper">
            <a href="#" class="logo">글램핑</a>
            <form class="search-form" action="search.php" method="GET">
                <div class="input-group">
                    <input type="text" placeholder="글램핑장을 검색해보세요 !" class="wide-input">
                </div>
                <div class="input-group">
    ...
    <section class="recommend-hotels">
        ...
        <div class="hotel-list">
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special11.jpg" alt="호텔 이미지">
                <div class="hotel-info">
                    <h3>라플란드</h3>
                    <p class="rating">몽골 감성 낭낭한 게르 형태의 <br>글램핑장 라플란드</p>
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special12.jpg" alt="호텔 이미지">
                <div class="hotel-info">
                    <h3>세교리 593</h3>
                    <p class="rating">150평 규모의 마당과 한옥을 <br>프라이빗하게 누릴 수 있는 곳</p>
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special13.jpg" alt="호텔 이미지">
                <div class="hotel-info">
                    <h3>아이리스 글램핑</h3>
                    <p class="rating">추운 겨울에도 따뜻하게 몸을 녹이고 땀을 쭉 뺄 수 있는 매력적인 곳</p>
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special14.jpg" alt="호텔 이미지">
                <div class="hotel-info">
                    <h3>저스트 글램핑</h3>
                    <p class="rating">돔 형태 텐트에서 색다른 캠핑을 <br>체험할 수 있는 저스트 글램핑</p>
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special15.jpg" alt="호텔 이미지">
                <div class="hotel-info">
                    <h3>고가원</h3>
                    <p class="rating">푸근한 감성을 제대로 즐길 수 있는 촌캉스 대표주자 고가원</p>
