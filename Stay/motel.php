...
$categoryLarge = $_GET['category_large'] ?? '모텔'; // 숙소 유형 필터
...
<body>
    ...
    <section class="search-section">
        <div class="search-wrapper">
            <a href="#" class="logo">모텔</a>
            <form class="search-form" action="search.php" method="GET">
                <div class="input-group">
                    <input type="text" placeholder="모텔을 검색해보세요 !" class="wide-input">
                </div>
                <div class="input-group">
    ...
    <section class="recommend-hotels">
        ...
        <div class="hotel-list">
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special1.jpg" alt="모텔 이미지">
                <div class="hotel-info">
                    <h3>월곶 Design Hotel XYM</h3>
                    <p class="rating">잠꾸러기들을 위한 오후 6시 퇴실<br><br></p>
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special2.jpg" alt="모텔 이미지">
                <div class="hotel-info">
                    <h3>이대 H Avenue</h3>
                    <p class="rating">글램핑 느낌의 모텔을 원한다?<br><br></p>
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special3.jpg" alt="모텔 이미지">
                <div class="hotel-info">
                    <h3>영등포 샵</h3>
                    <p class="rating">노래방, 당구, 다트 등 전 객실 <br>세련된 파티룸 구비 완료!</p>
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special4.jpg" alt="모텔 이미지">
                <div class="hotel-info">
                    <h3>건대 쁠랑</h3>
                    <p class="rating">전 객실 65인치 스마트TV,<br>신비로운 거울 룸</p>
            ...
            <div class="hotel-item">
                ...
                <img src="img/special/special5.jpg" alt="모텔 이미지">
                <div class="hotel-info">
                    <h3>건대 부티크나인</h3>
                    <p class="rating">호화로운 호캉스 느낌을<br> 받고 싶다면?</p>
